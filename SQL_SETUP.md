...
Paste the following SQL into the **Neon SQL Editor** to initialise the database.
...
Also add `DATABASE_URL` in **Vercel → Project → Settings → Environment Variables** for Production, Preview, and Development.
