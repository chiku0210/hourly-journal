// ─── Date & Time Utilities ────────────────────────────────────────────────────
// Shared helpers used by journal components.
// These are the same functions already inlined in app/journal/page.tsx —
// extracted here so they can be imported without modifying that file.
...
/** Returns last `n` days as YYYY-MM-DD strings, newest first */
...
/**
 * Formats YYYY-MM-DD into a human label:
 * "Today", "Yesterday", or "Mon Apr 01"
 */
